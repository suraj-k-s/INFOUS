  ...
  <body>
    ...
    >
      ...
      <tbody>
        <?php                   
                $i = 0;
                    $selQry = "SELECT * from tbl_booking b inner join tbl_seat s on s.booking_id=b.booking_id inner join tbl_schedule sh on sh.schedule_id=b.shedule_id inner join tbl_user u on u.user_id=b.user_id inner join tbl_route r on r.route_id=sh.route_id where u.user_id='".$_SESSION["uid"]."'";
