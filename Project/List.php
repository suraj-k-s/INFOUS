    ...
    >
      ...
      <tbody>
        <?php                   
				...
				/*	
                    $a = substr($stime,0,strlen($stime)-2);
                    $b = substr($stime,3,strlen($stime));
					if(strlen($st1+$b)>1) 
					{ 
						$ftime = $a.($st1+$b); 
					} 
