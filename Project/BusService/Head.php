    ...
    <body class="crm_body_bg">
        ...
        <nav class="sidebar">
            <div class="logo d-flex justify-content-between">
                <a href="HomePage.php"><h2 align="center">Welcome<br>Service<br><?php echo $_SESSION["bname"]?></h2></a>
            ...
            <ul id="sidebar_menu">
               ...
               <!-- <li class="">
                ...
                <li class="">
                        <a   class="has-arrow" href="BusSchedule.php" aria-expanded="false">
                            <img src="../Assets/Template/Admin/img/menu-icon/2.svg" alt="">
                            <span>Bus Schedule</span>
                        </a>	
                   </li>
                   <li class="">
                        <a   class="has-arrow" href="../Login.php" aria-expanded="false">
                            <img src="../Assets/Template/Admin/img/menu-icon/2.svg" alt="">
                            <span>Logout</span>
                        </a>	
                   </li>
