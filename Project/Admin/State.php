...
$dname = "";
	...
	if(isset($_GET['id']))
	{
		$del = "delete from tbl_state where state_id = '".$_GET['id']."'";
		if($con->query($del))
		{
			header("Location:State.php");
		}
                                        ...
                                        <div class="white_box mb_30">
                                            ...
                                            <form method="post">
                                                <div class="form-group">
                                                    ...
                                                    <input required="" type="text" class="form-control" id="txt_state" name="txt_state">
                                                </div>
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><a href="state.php?id=<?php echo $data["state_id"];?>" class="status_btn">Delete</a> &nbsp;&nbsp;&nbsp;&nbsp;
</td>                                            </tr>
                                            <?php                    
                                              }
