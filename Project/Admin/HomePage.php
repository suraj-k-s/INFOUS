                                            ...
                                            <div class="quick_activity_wrap">
                                                <div class="single_quick_activity d-flex">
                                                    ...
                                                    <div class="count_content">
                                                        ...
                                                        <?php
														$sel = "select count(bs_id) as id from tbl_bus_service";
                            ...
                            <div class="white_box card_height_100">
                                <div class="box_header border_bottom_1px  ">
                                    <div class="main-title">
                                        <h3 class="mb_25">Private</h3>
                                    </div>
                                </div>
                                <div class="staf_list_wrapper sraf_active owl-carousel">
                                <?php
								$selz = "select * from tbl_bus_service";
								$rowz = $con->query($selz);
								while($dataz = $rowz->fetch_assoc())
								{
                                    ...
                                    <div class="single_staf">
                                        <div class="staf_thumb">
                                            <img src="../Assets/Files/BusServicePhoto/<?php echo $dataz["bs_photo"];?>" alt="">
                                        </div>
                                        <h4><?php echo $dataz["bs_name"];?></h4>
                                        <p><?php echo $dataz["bs_contact"];?></p>
                                    </div>
                                    <?php
								}
								?>
